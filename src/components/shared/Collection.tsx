    ...
    <section className={`flex-col px-3 py-5 space-y-5 w-full justify-between items-center ${background  || 'bg-primary-theme2'} h-fit md:text-left text-center ${textColor}`}>
      <div className="flex md:flex-row flex-col-reverse w-full justify-between items-center h-fit md:py-7 py-5 lg:py-10">
        ...
        <div className="flex-1 flex justify-center items-center  md:w-1/2 pt-4 px-6">
          ...
          >
            <CarouselContent className="-ml-1 lg:gap-x-10 md:gap-x-7 gap-x-4">
                ...
                >
                  <div className="p-1">
                    <Card className="bg-transparent border-none shadow-none">
                      <CardContent className="flex bg-transparent items-center justify-center max-h-[200px] md:h-[300px] lg:max-h-[400px] lg:w-full w-auto">
                        <Image src={item.src} alt={item.alt} width={400} height={400} objectFit="cover" className="lg:min-h-[400px] w-full h-auto" />
                      </CardContent>
                    </Card>
                  </div>
                </CarouselItem>
